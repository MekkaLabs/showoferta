...
const SORT = {
  'trending-desc': 'Tendências',
  'latest-desc': 'Últimos lançamentos',
  'price-asc': 'Menor para maior preço',
  'price-desc': 'Maior para menor preço',
}
              ...
              {data ? (
                <>
                  ...
                  >
                    {q ? (
                      <>
                        Não encontramos o produto que você procura "<strong>{q}</strong>"
                      </>
                    ) : (
                      <>
                        Não existem itens nessa categoria.
                      </>
                    )}
                  </span>
                </>
